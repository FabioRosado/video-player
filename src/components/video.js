    ...
    <div className="relative">
      ...
      <div id="video-controls">
        <div className="left-side">
          ...
          <button
            className="player-button disabled-button"
            title="Volume (disabled)"
        ...
        <div className="right-side">
          <button
            className="player-button"
            title="Loop (l)"
            aria-label="Toggle video loopback (shorcut l)"
            onClick={() => toggleLoop()}
          >
          ...
          <button
            className="player-button"
            title="Fullscreen (f)"
            aria-label="Toggle fullscreen (shorcut f)"
            onClick={() => toggleFullscreen(player)}
          >
